/* Declares the Ritmota2 Audio Worklet Node */

class Ritmota2Controller extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "Ritmota2", options);
  }

  static importScripts (actx) {
    var origin = "https://marcwind.github.io/RitmotaRepo/";

    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/Ritmota2-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/Ritmota2-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
