...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Ritmota2 Demo Installer\n"
      else:
        line="OutputBaseFilename=Ritmota2 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Ritmota2 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Ritmota2 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Ritmota2 Demo installer\n"
     else:
       line="SetupWindowTitle=Ritmota2 installer\n"
