...
NOTARIZE_BUNDLE_ID=com.marcwindmusic.Ritmota2
NOTARIZE_BUNDLE_ID_DEMO=com.marcwindmusic.Ritmota2.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Ritmota2.iss
#  git checkout installer/Ritmota2.pkgproj
