...
Ritmota2::Ritmota2(const InstanceInfo& info)
...
#if IPLUG_EDITOR
void Ritmota2::OnParentWindowResize(int width, int height)
{
  if(GetUI())
...
#if IPLUG_DSP
void Ritmota2::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{ 
